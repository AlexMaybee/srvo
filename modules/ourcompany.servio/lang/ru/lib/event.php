<?php
$MESS['OUR_COMPANY_SETTINGS_SERVIO_URI_LINK_ERROR'] = 'В настройках модуля не указана ссылка для запросов в Servio!';
$MESS['OUR_COMPANY_SETTINGS_SERVIO_REST_KEY_ERROR'] = 'В настройках модуля не указан ключ для запросов в Servio!';
$MESS['OUR_COMPANY_SETTINGS_SERVIO_COMPANY_CODE_ERROR'] = 'В настройках модуля не указан код компании для запросов информации в Servio!';


$MESS['OUR_COMPANY_SETTINGS_SERVIO_RESERVE_CONFIRM_FILE_FORMAT_ERROR'] = 'В настройках модуля не указан формат получения файлов подтверждения резерва из Servio!';
$MESS['OUR_COMPANY_SETTINGS_SERVIO_BILL_FILE_FORMAT_ERROR'] = 'В настройках модуля не указан формат получения счетов из Servio!';
...
$MESS['OUR_COMPANY_SETTINGS_SERVIO_FIELD_BILL_FILE_ID_ERROR'] = 'В настройках модуля не указано ID поля кодов файлов счетов!';
$MESS['OUR_COMPANY_SETTINGS_SERVIO_FIELD_BILL_FILE_ERROR'] = 'В настройках модуля не указано ID поля файлов счетов!';